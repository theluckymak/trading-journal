...
export default function TradeDetail() {
  ...
  const fetchJournal = async () => {
    try {
      const response = await fetch(`https://trading-journal-production-8248.up.railway.app/api/journal/entries/${id}`, {
        headers: {
  ...
  const saveJournal = async () => {
    try {
      ...
      const url = `https://trading-journal-production-8248.up.railway.app/api/journal/entries/${id}`;
      const method = 'POST';
